...
| Move every top-level reminder from one list to another | `list-move SOURCE DEST` or `list-move --from-id ID --to-id ID` | No | `show <destination> --json` and `show <source> --json` |
